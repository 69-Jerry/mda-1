const Events = () => {
  return (
    <section className="py-24 bg-mda-cream/50">
      <div className="max-w-7xl mx-auto px-8 text-center mb-16">
        ...
        <h2 className="text-6xl lg:text-7xl font-display text-mda-maroon mb-6">
          UPCOMING EVENTS
        </h2>
        <div className="w-24 h-1 bg-mda-pink mx-auto" />
      </div>

      <div className="max-w-7xl mx-auto px-8">
        <div className="bg-white rounded-[3rem] p-24 text-center border border-mda-maroon/5 shadow-2xl">
