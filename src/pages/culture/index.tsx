  ...
  return (
    <div className="bg-mda-cream min-h-screen">
      ...
      <section className="relative py-32 bg-mda-maroon overflow-hidden min-h-[60vh] flex items-center">
        {/* Animated Mesh Glows */}
        <div className="absolute top-0 right-0 w-[700px] h-[700px] bg-mda-pink/10 rounded-full blur-[140px] pointer-events-none animate-pulse-glow" />
        <div className="absolute -bottom-20 -left-20 w-[500px] h-[500px] bg-mda-pink/5 rounded-full blur-[100px] pointer-events-none animate-pulse-glow" />
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-20 animate-reveal">
          <div className="max-w-4xl space-y-8 text-center lg:text-left mx-auto lg:mx-0">
            ...
            <p className="font-body text-2xl text-white/50 leading-relaxed max-w-2xl border-l border-mda-pink/30 pl-8 mx-auto lg:mx-0">
          ...
          <div className="grid lg:grid-cols-[1fr_2.5fr] gap-24 items-start">
            <div className="space-y-10 lg:sticky lg:top-32">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-3 px-5 py-2 glass-card rounded-full border-mda-maroon/10 uppercase font-bold tracking-[0.3em] text-[10px] text-mda-maroon">
                  Indigenous Core
                </div>
                <h2 className="text-7xl font-display text-mda-maroon leading-[0.8] uppercase tracking-tighter">
                  THE SEVEN <br />
                  <span className="text-mda-pink italic font-serif normal-case text-glow">
                    Pillars
                  </span>
              ...
              <p className="font-body text-xl text-mda-dark/50 leading-relaxed max-w-sm">
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="glass-card p-10 rounded-[3rem] border-mda-maroon/5 group hover:border-mda-pink hover:-translate-y-2 transition-all duration-700 h-[280px] flex flex-col justify-between"
                >
                  <div className="text-mda-pink font-display text-4xl mb-4 group-hover:scale-110 transition-transform origin-left">
                    0{i + 1}
                  </div>
                  <div>
                    <h3 className="text-4xl font-display text-mda-maroon mb-4 uppercase tracking-tighter">
                      {clan.name}
                    </h3>
                    <p className="text-base font-body text-mda-dark/40 group-hover:text-mda-dark/80 transition-colors">
                      {clan.desc}
                    </p>
                  </div>
                </div>
      ...
      <section className="py-40 bg-mda-maroon text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-mda-pink/5 rounded-full blur-[120px] pointer-events-none" />

        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-32 items-center">
            <div className="relative group order-2 lg:order-1 transition-all duration-1000">
              <div className="aspect-square glass-card p-4 rounded-[4rem] group-hover:-rotate-2 transition-transform duration-700">
              ...
              <div className="absolute -top-10 -left-10 glass-card p-8 rounded-3xl animate-float border-white/20">
                <div className="text-3xl font-display text-mda-pink">
                  AUGUST
                </div>
            ...
            <div className="space-y-12 order-1 lg:order-2">
              ...
              <p className="font-body text-2xl text-white/50 leading-relaxed border-l border-mda-pink/20 pl-10">
                A grand celebration of reunion, reconciliation, and the
                collective advancement of our people.
              </p>
              <div className="grid grid-cols-2 gap-12 pt-4">
                <div className="space-y-4">
                  <h4 className="text-white font-display text-2xl uppercase tracking-widest border-b border-white/10 pb-4">
                    Duration
                  </h4>
      ...
      <section className="py-40 bg-white">
        <div className="max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-32">
          <div className="space-y-12 animate-reveal">
            <div className="space-y-8">
              <h2 className="text-7xl font-display text-mda-maroon uppercase tracking-tighter">
                INDIGENOUS <br />
                <span className="text-mda-pink italic font-serif normal-case">
                  Attire
                </span>
              </h2>
              <p className="font-body text-xl text-mda-dark/50 leading-relaxed">
                Our hand-woven Kente and specialized ancestral wraps carry
                patterns that chronicle lineage and status.
              </p>
            </div>
            <div className="aspect-[16/10] glass-card p-3 rounded-[3.5rem] overflow-hidden group">
          ...
          <div className="space-y-12 lg:pt-32 animate-reveal delay-300">
            <div className="space-y-8">
              <h2 className="text-7xl font-display text-mda-maroon uppercase tracking-tighter">
                RIVER <br />
                <span className="text-mda-pink italic font-serif normal-case">
            ...
            <div className="grid grid-cols-2 gap-6 pb-12">
              {[
                ...
                <div
                  key={i}
                  className="aspect-square glass-card p-2 rounded-[2.5rem] overflow-hidden group"
                >
            ...
            {[
              ...
              >
                <div className="w-20 h-20 bg-mda-maroon rounded-3xl flex items-center justify-center mx-auto transition-transform group-hover:scale-110">
                  <site.icon size={36} className="text-mda-pink" />
                </div>
                <div className="space-y-4">
