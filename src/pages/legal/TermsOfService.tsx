...
const TermsOfService = () => {
  ...
  return (
    <div className="bg-mda-cream min-h-screen">
      ...
      <section className="relative py-40 bg-mda-maroon overflow-hidden min-h-[50vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-20 animate-reveal">
          <div className="max-w-4xl space-y-12 text-center lg:text-left">
            ...
            <p className="font-body text-xl opacity-40 uppercase tracking-[0.5em] text-white">
      ...
      <section className="py-40 px-8 relative z-20">
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="grid gap-12">
            {terms.map((term, i) => (
              <div
                key={i}
                className="glass-card bg-white p-12 lg:p-20 rounded-[4rem] border-white shadow-[0_40px_100px_-20px_rgba(93,26,26,0.05)] space-y-8 group hover:-translate-y-2 transition-all duration-700"
              >
                <div className="flex items-center justify-between">
                  <h2 className="text-4xl lg:text-5xl font-display text-mda-maroon uppercase tracking-tighter flex items-center gap-6 leading-none">
                ...
                <p className="font-body text-mda-dark/50 leading-relaxed text-xl border-t border-mda-maroon/5 pt-8">
                  {term.content}
                </p>
              </div>
            ))}
          ...
          <div className="mt-24 p-12 lg:p-20 glass-card bg-mda-maroon rounded-[4rem] border-white/5 flex flex-col md:flex-row gap-12 items-center relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full blur-3xl -translate-y-12 translate-x-12" />
            <div className="w-24 h-24 glass-card bg-mda-pink rounded-3xl flex items-center justify-center shrink-0 shadow-2xl animate-float">
              <AlertCircle className="text-mda-maroon" size={48} />
            </div>
            <p className="font-display text-2xl lg:text-4xl text-white/80 uppercase italic leading-tight tracking-tighter">
